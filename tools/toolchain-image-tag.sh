...
# hash of docker/ (recipes, docker/wrappers/) combined with the blob
# hashes of the two files outside it that shape image content (the
# msan-libc++ build script baked into clang22, and the image workflow
# itself). Identical content always
