...
# Attaches every registered kernel's objects to <target>, defines
# BLAKE3PP_HAS_KERNEL_<NS> for kernel.hpp's extern declarations, and
# generates the kernel registry, an X-macro list of exactly the variants
# in THIS binary. dispatch.cpp expands it into extern declarations and its
# dispatch/query tables, so the blake3pp_add_kernel() calls are the single
# source of truth: registering a variant here is all it takes for it to
# appear in dispatch, compiled_arches() and available_arches().
